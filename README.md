...
Note: Enemies have 100 base health. The UI in the upper-left corner displays simple debug text for ability cooldowns, Aura Flame duration, enemy health, and death confirmation.
